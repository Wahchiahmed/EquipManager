...
const navByRole: Record<Role, NavItem[]> = {
  ...
  ADMIN: [
    ...
    // ✅ Admin-specific URLs — never overlap with stock/manager routes
...
const Sidebar: React.FC<SidebarProps> = ({ collapsed, onToggle }) => {
  ...
  const navItems = navByRole[currentUser.role_nom];
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2.5">
              ...
              <div className="min-w-0 flex-1">
                ...
                <span className={cn(
                  'inline-block text-[10px] px-1.5 py-0.5 rounded font-medium text-white',
                  roleColors[currentUser.role_nom]
                )}>
